...
def unit_data_extractor(compressed=True):
    """
    Extracts units data from the data source URL. This is an abbr mapper to its meaning.
    ...
    url = f"https://ec.europa.eu/eurostat/api/dissemination/sdmx/2.1/codelist/ESTAT/UNIT/?compressed={compressed}&format=TSV&lang=en"
